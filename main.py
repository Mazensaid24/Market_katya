...
"""
api_id = 22861564
api_hash = "d21d3241e065ab83a101b10fd750201b"
token = "6982691255:AAH0N5J7nLbXAPU789yjDBDp0Zz4xFK2PM0"
OWNER_NAME = "𝗩𝗶𝗽 𝗠 𝗮 𝗭 𝗲 𝗡"
...
async def neww(client,message):
	...
	xrb3 = """
	✦ [جروب اذاعه القرءان الكريم](https://t.me/Source_Katya)
	
	✦ [ قناة البوستات ](https://t.me/fv_av)
	
	✦ [قناة السوࢪس](https://t.me/fv_av)
	
	✦ [ جࢪوب تانيه ثانوى مذاكرة](https://t.me/miika3)
	
	✦ [ بوت وندا للحمايه](https://t.me/aZx9bot)
...
async def tanc(client,message):
	...
	await message.reply(
	"**يمكنك الدخول لجروب الدعم لتنصيب مثل هذا البوت**\n\n**جروب الدعم : @miika3",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("-Channel",url="https://t.me/fv_av")]]))
